...
public class FormActivity extends AppCompatActivity {
    ...
    private String nama_ahasiswa, nim_mahasiswa, jeniskelamin_mahasiswa, prodi_mahasiswa, hobi_mahasiswa, semester_mahasiswa;
...
//      Atur input NIM menjadi focus pertama
        nama.requestFocus();
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                nama_ahasiswa = nama.getText().toString();
...
//                        resetForm();
                        ...
                        intent.putExtra("nama",nama_ahasiswa );
